...
SWEP.PrintName = ""..translate.Get"wpn_ender_name"
SWEP.Description = ""..translate.Get"wpn_ender_desc"
...
GAMEMODE:AddNewRemantleBranch(SWEP, 1, ""..translate.Get"wpn_ender_variant_name", ""..translate.Get"wpn_ender_variant_desc", function(wept)
