...
<p>라운드 시작 전 일정 수의 사람이 선택되어 첫 좀비들이 됩니다. 누가 선택될지는 화면 하단에 표시됩니다.</p>
...
<table>
  ...
  <tr>
   ...
   <tr>
    <td>탄약 메뉴</td>
    <td>왼쪽 Alt</td>
    <td>이 메뉴에서 탄약을 떨구거나 다른 사람한테 줄 수 있습니다.<br>또한 일부 퍼크를 끄거나 켤 수 있습니다.</td>
  </tr>
</table>
</ul></p>
]]
LANGUAGE.help_cont_survival							= [[<p>팁:
<ul><li>'gmod_undo'키(기본값: Z)를 눌러 아주 느리게 바리케이드를 통과할 수 있습니다.</li>
...
<li>저항력 표시기는 현재 넉백에 대해 얼마나 저항력을 갖고 있는지 표시하며 좀비들이 많으면 많을수록 저항력이 강해집니다!</li>
...
<p>좀비 서바이벌엔 바리케이드를 구성하기 위한 도구가 있습니다. 바로 '목수의 망치'와 '못'이다. 이들은 프롭을 단단히 고정해 주며, 좀비들은 이 튼튼한 바리케이드를 부수지 않고는 당신에게 아무런 위해를 가하지 못합니다.<br>
원하는 프롭을 보고 '사용'키(기본값: E)를 눌러 프롭을 들어 올립니다. '달리기'키(기본값: Shift)를 눌러 판자를 원하는 위치에 임시로 고정할 수 있습니다.<br>
그 상태에서 망치를 들고 오른쪽 클릭으로 못을 박아 고정하시면 됩니다. 다른 프롭들에 박는 것 보다 벽, 천장 등 고정된 물건에 못을 박으면 더 안전하게 생존할 수 있죠.
기억하세요! 여러분은 망치로 프롭이나 못을 수리할 수 있습니다. 하지만, 계속 수리를 하다 보면 결국 너무 너덜너덜해져 사용할 수 없게 됩니다. 망치를 들고 '달리기'키(기본값: Shift)를 눌러서 화면에 보이는 못의 주인과 체력을 확인할 수 있습니다.
만약 못이 이상한 곳에 박혔다고 생각되거나, 프롭의 위치를 옮기고 싶으면 '재장전'키(기본값: R)을 눌러 뺄 수 있습니다. 하지만 주의하세요. 만약 자신의 못이 아닌 다른 사람의 못을 제거한다면 벌을 받습니다.
...
판자를 사용하므로 사용할 때마다 보드가 하나씩 사용됩니다! '달리기'키(기본값: Shift)를 눌러 설치된 판자를 회수하여 다시 쓸 수 있다.</p>
<p>마지막으로, '자동 터렛'이 있습니다. 터렛은 레이저에 닿은 모든 좀비에게 총알을 발사합니다. 탄약이 없을 때엔 레이저가 빨간색으로 변하며 기능이 정지됩니다.<br> 
SMG탄약이 있다면, 터렛을 보고 'USE'키(기본값: E)를 눌러 충전시킬 수 있고 충전할 경우에는 포인트를 받습니다.<br>
기억하세요. 터렛은 레이져에 닿은 좀비만 공격합니다.</p>
<p>팁:
<ul>
<li>크고 무거운 프롭을 바리케이드로 사용하세요. 못의 체력이 더 많아지고, 못을 박을 수 있는 자리도 더 많아집니다.</li>
<li>바리케이드는 발사체도 막습니다.(Ex: 독)</li>
</ul></p>]]
LANGUAGE.help_cont_upgrades							= 
[[<p>포인트는 좀비를 죽이거나, 팀을 치료하거나, 터렛의 탄환을 충전하거나, 상점상자를 운영하거나, 보급상자를 설치하거나 바리케이드를 수리함으로써 얻을 수 있다.
그렇게 얻은 포인트들은 포인트 샵에서 생존에 필요한 무기, 도구 등으로 교환할 수 있습니다.
...
<li>자금과 포인트는 같은 개념이 아닙니다. 라운드 시작 전, 자금을 전부 쓰는 것이 좋습니다!</li>
...
<li>만약 너무 어둡다면, '플래시시'키(기본: F)를 눌러보세요. 인간의 정확한 위치까지 나타나는 좀비 비전을 사용할 수 있습니다.</li>
</ul></p>
]]