...
LANGUAGE.cant_use_worth_anymore						= "Вы больше не можете использовать меню наборов!"
...
LANGUAGE.description_butcher						= "Обезумевший мясник нежити. Он не очень живучий, но любой, кому не повезло быть рядом, скорее всего, будет разорван в клочья."
...
LANGUAGE.controls_giga_gore_child					= "> ПЕРВИЧНЫЙ: Удар\n> ВТОРИЧНЫЙ: Кинуть куклу"
LANGUAGE.controls_butcher							= "> ПЕРВИЧНЫЙ: Рубящий удар"
LANGUAGE.controls_flesh_creeper						= "> ПЕРВИЧНЫЙ: Удар\n> ВТОРИЧНЫЙ: Создать гнездо"
...
LANGUAGE.worth_clear								= "Очистить Набор"
LANGUAGE.worth_cleartooltip							= "Очистить все товары из вашей корзины."
LANGUAGE.worth_saveload								= "Сохранить Набор"
...
LANGUAGE.ars_worth                                  = "Меню Наборов"
...
LANGUAGE.options_no_floating_score                  = "Не показывать всплывающие показатели очков"
...
LANGUAGE.options_no_boss_pick                       = "Запретить быть выбранным будучи в качестве босса"
...
LANGUAGE.ammo_pulse                                 = "Пульсовые Заряды"
