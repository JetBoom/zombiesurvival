...
LANGUAGE.class_gore_child							= "Кровавый Ребенок"
LANGUAGE.class_giga_gore_child						= "Гига Кровавый Ребенок"
...
LANGUAGE.description_giga_gore_child				= "Результат Кровавого Ребенка, который был незамеченным слишком долго.\nУжас, чтобы созерцать, его массивное тело является результатом зомбированных стволовых клеток.\nОни также будут хозяином для Кровавых Детей которые можно всегда находить в кудели с им."
