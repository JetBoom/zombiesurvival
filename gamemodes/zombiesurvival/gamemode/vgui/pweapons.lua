...
function MakepWeapons(silent)
	...
	for _, wep in pairs(crafts) do
		...
		wepnode.SWEP = wep
		wepnode.DoClick = WeaponButtonDoClick
		wepnode.Category = enttab.RequiredClip and ITEMCAT_GUNS or (enttab.Primary.Ammo == "none" and (enttab.HitDistance or enttab.MeleeRange)) and ITEMCAT_MELEE or ITEMCAT_TOOLS
