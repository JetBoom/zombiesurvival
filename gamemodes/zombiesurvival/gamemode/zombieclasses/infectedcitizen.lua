CLASS.Name = "Infected Citizen"
CLASS.TranslationName = "class_infected_citizen"
CLASS.Description = "description_infected_citizen"
...
CLASS.SWEP = "weapon_zs_infectedcitizen"
