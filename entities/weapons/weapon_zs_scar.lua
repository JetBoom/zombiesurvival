...
if CLIENT then
	SWEP.PrintName = translate.Get("craft_scar")
	SWEP.Slot = 2
	SWEP.SlotPos = 0
...
SWEP.Primary.Damage = 28 SWEP.Primary.NumShots = 1
SWEP.Primary.Delay = 0.115 SWEP.Primary.ClipSize = 25
...
function SWEP:EmitFireSound()
	self:EmitSound(self.Primary.Sound, 10, 100)
end
