...
if CLIENT then
	SWEP.PrintName = translate.Get("craft_empower")
	SWEP.Description = translate.Get("craft_empower_desk")
	...
	SWEP.VElements = {
		["base"] = { type = "Model", model = "models/props_junk/Shoe001a.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(4.091, 3.181, -0.456), angle = Angle(-54.206, -62.294, -50.114), size = Vector(0.492, 0.492, 0.492), color = Color(255, 255, 255, 255), surpresslightning = false, material = "models/player/shared/gold_player", skin = 0, bodygroup = {} }
	}

	SWEP.WElements = {
		["base"] = { type = "Model", model = "models/props_junk/Shoe001a.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.181, 2.273, -0.456), angle = Angle(-43.978, 27.614, 70.568), size = Vector(0.379, 0.379, 0.379), color = Color(255, 255, 255, 255), surpresslightning = false, material = "models/player/shared/gold_player", skin = 0, bodygroup = {} }
	}
end
...
function SWEP:PlayHitSound()
	self:EmitSound("zombiesurvival/boot"..math.random(3)..".ogg", 75, math.random(80, 100))
end

function SWEP:PlaySwingSound()
	self:EmitSound("zombiesurvival/boot"..math.random(3)..".ogg", 75, math.random(85, 95))
end
