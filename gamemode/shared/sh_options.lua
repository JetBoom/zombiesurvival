...
GM:AddStartingItem("bffastresupply", ""..translate.Get("worth_crateshare"), ""..translate.Get("worth_crateshare"), ITEMCAT_TRAITS, 25, nil, function(pl) pl.CrateShare = true end, "models/healthvial.mdl")
-----------
-- W.RETURNS --
-----------
