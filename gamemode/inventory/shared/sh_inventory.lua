...
GM.Assemblies["weapon_zs_fracture"] 							= {"comp_pumpaction",		"weapon_zs_doublebarrel"}
...
inket = GM:AddTrinket("Barbed Armor", "barbedarmor", false, develes, deweles, 2, "50% of melee damage taken reflected back to melee attackers\nAdditional 7 damage reflected back to melee attackers\nMelee attackers take 7 arm damage\n-3% melee damage taken")
GM:AddSkillModifier(trinket, SKILLMOD_MELEE_ATTACKER_DMG_REFLECT, 7)
GM:AddSkillModifier(trinket, SKILLMOD_MELEE_ATTACKER_DMG_REFLECT_PERCENT, 0.50)
