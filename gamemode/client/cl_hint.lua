...
function DrawIconHint(text, image, pos, delta, scale, color)
	local eyepos = EyePos()

	if WorldVisible(eyepos, pos) then return end
	...
	draw.SimpleText(text, "ZS3D2DFont2Small", 0, 70, Vector(255, 255, 255, 255), TEXT_ALIGN_CENTER)
