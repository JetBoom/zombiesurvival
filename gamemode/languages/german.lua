...
LANGUAGE.need_to_be_near_arsenal_crate				= "Du musst in der Nähe einer Arsenalkiste sein, um einen Artikel kaufen zu können!"
...
LANGUAGE.arsenal_crate								= "Arsenalkiste"
...
LANGUAGE.x_has_built_this_nest_and_is_still_around	= "Du kannst das Nest nicht zerstören, da %s immer noch im Spiel ist."
...
LANGUAGE.sigil_destroyed_only_one_remain_h			= "Es ist nur noch einer übrig! Wenn er fällt, dann gibt es keine Hoffnung auf Flucht!"
...
LANGUAGE.last_sigil_destroyed_all_is_lost2			= "Es gibt keine Hoffnung auf Flucht."
...
LANGUAGE.sigil_yousurvived							= "Du hast überlebt! Warte auf andere Überlebende..."
LANGUAGE.sigil_teleporting							= "Teleportiere nach %s"
...
LANGUAGE.message_beacon_4							= "Brauchen Arsenalkiste hier"
LANGUAGE.message_beacon_5							= "Brauchen Sanitäter hier"
LANGUAGE.message_beacon_6							= "Resupply-Box hier"
LANGUAGE.message_beacon_7							= "Arsenalkiste hier"
...
LANGUAGE.description_poison_zombie					= "Dieser mutierte Zombie ist nicht nur extrem langlebig, er besitzt auch noch abnormale Kräfte.\nSein Körper ist extrem giftig. Er kann sogar sein eigenes Fleisch herausreißen um es auf Dinge zu werfen, die zum Schlagen zu weit entfernt sind."
LANGUAGE.description_fast_zombie					= "Dieser knochige Kadaver ist viel schneller als andere Zombies.\nAlleine sind sie keine große Bedrohung, aber mit ihren rasiermesserscharfen Klauen können sie fast jedes Gebiet, durch Klettern, erreichen.\nSie haben auch kein Problem damit, schwache oder verletzte Menschen zu jagen."
LANGUAGE.description_bloated_zombie					= "Ihre Körper beinhalten flüchtige und giftige Chemikalien.\nSie bewegen sich etwas langsamer, können dafür aber mehr einstecken."
...
LANGUAGE.description_burster						= "Dieser Infizierte kann explodieren, wenn er getötet wird."
...
LANGUAGE.help_cont_introduction						= [[<p>    Willkommen bei Zombie Survival, dem (Zombie-)Überlebenssimulator. ZS ermöglicht es dir Zombie-Angriffe zu bekämpfen, Barrikaden zu errichten und sogar Teil der untoten Horde zu sein.</p>

<p>Es gibt zwei Teams: die Überlebenden und die Zombies. Die Menschen gewinnen, wenn sie jede Welle überleben. Einige Levels haben spezielle zu erfüllende Ziele, die optional oder zum Gewinnen erforderlich sein können.
Wenn ein Mensch getötet wird, dann kommt er als Zombie zurück, was das Spiel für die übrigen Menschen noch schwieriger macht.</p>

<p>Das Ziel für die Zombies ist es, alle Menschen zu töten, so dass diese alle Zombies sind und jeder die Runde verliert. Alternativ kann ein Zombie vier Menschen töten, um erlöst (redeemed) zu werden. Dies ermöglicht ihm eine zweite Chance auf Überleben und Sieg.
Denke daran, dass die einzige Möglichkeit zu gewinnen darin besteht bei Rundenende ein Mensch zu sein. Zombies können technisch gesehen das Spiel nicht gewinnen; Zombies können nur dazu beitragen, alle anderen verlieren zu lassen!</p>

<p>Eine bestimmte Anzahl von Menschen werden ausgewählt (oder stellen sich freiwillig), um die beginnenden Zombies zu sein. Die Anzahl wird vor Rundenstart am unteren Rand des Bildschirms angezeigt.</p>

<p><b>Benutze die Tabs am oberen Fensterrand, um Hilfe zu spezifischeren Dingen zu erhalten.</b></p>

<p>Tipps für diesen Abschnitt:
<ul><li>Wenn du das Spiel als Mensch verlässt, dann wirst du als Zombie wiederkommen.</li>
<li>Nach einer gewissen Zeitspanne werden sogar neue Spieler als Zombies spawnen.</li>
<li>Benutze den TEAM CHAT wenn nötig. Die Standardtaste ist U, und erlaubt es nur mit Teammitgliedern zu sprechen.</li>
</ul></p>
]]
...
LANGUAGE.worth_randomtooltip						= "Bei Verwendung erhälst du nach dem Zufallsprinzip eine Auswahl an Gegenständen.\nDes Weiteren schließt diese Schaltfläche das Worth-Menü."
...
LANGUAGE.worth_githubtooltip						= "Diese Schaltfläche führt zur GitHub-Seite dieses modifizierten Zombie Survival Spielmodus."
...
LANGUAGE.msgbeacon_text								= "Wähle eine Nachricht"
...
LANGUAGE.worth_3pistol								= "3 Boxen Pistolen-Munition"
LANGUAGE.worth_3shotgun								= "3 Boxen Schrotflinten-Munition"
LANGUAGE.worth_3smg									= "3 Boxen SMG-Munition"
LANGUAGE.worth_3assaultrifle						= "3 Boxen Sturmgewehr-Munition"
LANGUAGE.worth_3rifle								= "3 Boxen Gewehr-Munition"
LANGUAGE.worth_3pulse								= "3 Boxen Pulse-Munition"
LANGUAGE.worth_5pistol								= "5 Boxen Pistolen-Munition"
LANGUAGE.worth_5shotgun								= "5 Boxen Schrotflinten-Munition"
LANGUAGE.worth_5smg									= "5 Boxen SMG-Munition"
LANGUAGE.worth_5assaultrifle						= "5 Boxen Sturmgewehr-Munition"
LANGUAGE.worth_5rifle								= "5 Boxen Gewehr-Munition"
LANGUAGE.worth_5pulse								= "5 Boxen Pulse-Munition"
...
LANGUAGE.worth_arsenalcrate							= "Arsenalkiste"
...
LANGUAGE.worth_carpenter2							= "50% geringere Verzögerung bei der Verwendung des Hammers."
LANGUAGE.worth_cannibal								= "Cannibalism"
LANGUAGE.worth_cannibal2							= "Du kannst Innereien von Zombies und Menschen essen, um Lebenspunkte zu erhalten.\nBerühre einfach die Fleischklumpen, um sie zu essen."
LANGUAGE.worth_fastteleport							= "Teleporter"
LANGUAGE.worth_fastteleport2						= "Du kannst nahezu ohne Verzögerung teleportieren."
LANGUAGE.worth_allergic								= "Allergic"
LANGUAGE.worth_allergic2							= "Gift verursacht doppelt so viel Schaden im Austausch für Worth."
...
LANGUAGE.ars_pistol_ammo							= "Pistolen-Munition"
LANGUAGE.ars_shotgun_ammo							= "Schrotflinten-Munition"
LANGUAGE.ars_smg_ammo								= "SMG-Munition"
LANGUAGE.ars_assaultrifle_ammo						= "Sturmgewehr-Munition"
LANGUAGE.ars_rifle_ammo								= "Gewehr-Munition"
LANGUAGE.ars_bolt									= "Armbrustbolzen"
LANGUAGE.ars_pulse_ammo								= "Pulse-Munition"
...
LANGUAGE.craft_dualboomstick						= "Doppelter Boom Stick"
LANGUAGE.craft_dualboomstickdesk					= "Diese Schrotflinten ermöglichen es jeweils bis zu vier Patronen gleichzeitig in die Kammer zu laden. Halte NACHLADEN gedrückt, um das Laden der einzelnen Patronen zu beschleunigen."
LANGUAGE.craft_empowershovel						= "\"Empowered\" Schaufel"
LANGUAGE.craft_empowerkongol						= "\"Empowered\" Kongol-Axt"
LANGUAGE.craft_jethammer							= "Jet-Hammer"
LANGUAGE.craft_jethammerdesk						= "Angetrieben von kräftigen Strahltriebwerken. Dieser Hammer benötigt einige Zeit zum Aufladen, aber verursacht im Gegenzug extreme Schäden und besitzt einen großen Rückschlag."
LANGUAGE.craft_kongol								= "Kongol-Axt"
LANGUAGE.craft_multiinferno							= "\"Multi Inferno\" AUG"
LANGUAGE.craft_nukemasher							= "Nuke Masher"
LANGUAGE.craft_scar									= "\"Terminus\" SCAR-L"
LANGUAGE.craft_volcanoarm							= "\"Volcano Arm\" Pistole"
LANGUAGE.craft_volcanoarmdesk						= "Diese Waffe verursacht sehr großen Schaden. Das ist alles."
...
LANGUAGE.wn_turretcontroll							= "Selbstschussanlagen-Fernsteuerung"
...
LANGUAGE.msgbeacon_desk								= "Mit diesem Beacon kannst du Nachrichten für alle anderen Menschen in Reichweite ausgeben.\nDrücke SEKUNDÄRANGRIFF, um zwischen verschiedenen Nachrichten zu wählen.\nDrücke PRIMÄRANGRIFF zum Platzieren.\nDrücke SPRINTEN auf einem deiner Beacons, um diesen aufzunehmen."
...
LANGUAGE.magnum_desk								= "Die Kugeln dieser Waffe prallen von Wänden ab, um dann mehr Schaden anzurichten."
...
LANGUAGE.bulletstorm_desk							= "Halte die rechte Maustaste gedrückt, um den Sturm-Feuermodus zu verwenden: Die Feuerrate wird auf 60% reduziert, aber zwei Kugeln werden gleichzeitig abgefeuert."
...
LANGUAGE.hm_scarecrow2								= "geht an %s, für das Töten von %d armen Krähe(n)."
...
LANGUAGE.hm_salesman2								= "ist was %s ist, für das Verkaufen von Ausrüstung durch seine Arsenalkisten im Wert von %d Punkten."
...
LANGUAGE.options_no_ars_crate						= "Zeige keine verdeckten Arsenalkisten"
LANGUAGE.options_no_resupply						= "Zeige keine verdeckten Resupply-Boxen"
...
LANGUAGE.options_no_bandit							= "Deaktiviere, ein Bandit zu werden"
...
LANGUAGE.options_intro_music						= "Aktiviere Intro-Musik"
...
LANGUAGE.ammo_ars									= "Arsenalkisten"
