...
function GM:Initialize()
    print('Finding and adding files to be downloaded')
    print('Finding and adding zs content for download')
    self:SetDownloadbleContent("gamemodes/zombiesurvival/content")
    print('Finished setting up files for download!')
    print('Adding workshop models..')
    resource.AddWorkshop( "368616717" )
    resource.AddWorkshop( "266233945" )
    resource.AddWorkshop( "512670299" )
    resource.AddWorkshop( "636717913" )
    resource.AddWorkshop( "897857141" )
    resource.AddWorkshop( "465449464" )
    resource.AddWorkshop( "615021118" )
    resource.AddWorkshop( "517289196" )
    resource.AddWorkshop( "686354388" )
    resource.AddWorkshop( "771654933" )
    resource.AddWorkshop( "471628201" )
    resource.AddWorkshop( "855330097" )
    resource.AddWorkshop( "840558476" )
    resource.AddWorkshop( "663218263" )
    resource.AddWorkshop( "575153928" )
    resource.AddWorkshop( "698495301" )
    resource.AddWorkshop( "366438805" )
    resource.AddWorkshop( "332467438" )
    resource.AddWorkshop( "654384195" )
    resource.AddWorkshop( "840562680" )
    resource.AddWorkshop( "1373364254" )
    resource.AddWorkshop( "543329822" )
    resource.AddWorkshop( "1529698877" )
    resource.AddWorkshop( "1318164255" )
    resource.AddWorkshop( "1267287732" )
    resource.AddWorkshop( "934770064" )
    resource.AddWorkshop( "235587037" )
    resource.AddWorkshop( "949538921" )
    resource.AddWorkshop( "351358461" )
    resource.AddWorkshop( "1531399443" )
    resource.AddWorkshop( "1124153474" )
    resource.AddWorkshop( "1125839271" )
    resource.AddWorkshop( "764734191" )
    resource.AddWorkshop( "796190265" )
    resource.AddWorkshop( "1512479481" )
    resource.AddWorkshop( "216066328" )
    print('Finished adding workshop models!')
...
function GM:EntityTakeDamage(ent, dmginfo)
    ...
    if self:GetWave() <= 0 and string.sub(ent:GetClass(), 1, 12) == "prop_physics" and inflictor.NoPropDamageDuringWave1 then
        dmginfo:SetDamage(0)
